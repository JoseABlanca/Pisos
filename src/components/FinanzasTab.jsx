...
import { FileText, Plus, Trash2, PieChart, Database, BarChart2 } from 'lucide-react';
import ExtractoTab from './ExtractoTab';

export default function FinanzasTab({ formData, setFormData, rentals }) {
      ...
      return (
        <div className="flex flex-col gap-4 p-4 flex-1 overflow-auto bg-[#d4d0c8]">
          <div className="grid grid-cols-2 gap-6">
            ...
            {/* Right Column: Gastos de Adquisición Table */}
            <div className="space-y-2">
              ...
              <div className="bg-white border border-[#808080] shadow-[1px_1px_0px_#000] p-1 h-[250px] flex flex-col">
                  ...
                  <table className="clean-table w-full">
                    ...
                    <tbody>
                      {adquisitionExpenses.length === 0 ? (
                        <tr>
                          <td colSpan="3" className="text-center text-slate-500 py-4 italic text-[11px]">
