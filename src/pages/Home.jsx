...
export default function Home() {
  const modules = [
    ...
    { name: 'Renta variable', icon: TrendingUp },
    { name: 'Crowdfunding', icon: Coins },
    { name: 'Impuestos', icon: Percent },
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-4 max-w-xl">
          {modules.map(mod => (
            <button
              ...
              className="flex items-center space-x-2 border border-gray-300 bg-white hover:bg-blue-50 px-3 py-1.5 min-w-[160px] transition-colors shadow-sm"
            >
