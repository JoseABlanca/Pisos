  ...
  return (
    <div className="p-6 max-w-4xl mx-auto flex flex-col h-full">
      <div className="flex items-center justify-between mb-6 shrink-0">
        ...
        {/* Tab selection */}
        <div className="flex border border-outline-variant rounded-lg overflow-hidden bg-surface-low">
          <button
            type="button"
            onClick={() => setActiveTab('sistema')}
            className={`px-4 py-2 text-xs font-black uppercase tracking-wider transition-all ${activeTab === 'sistema' ? 'bg-primary text-white' : 'text-on-surface-variant hover:bg-surface-lowest'}`}
          >
            Sistema
          </button>
          <button
      ...
      <div className="flex-1 min-h-0">
        {activeTab === 'sistema' ? (
          <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-background border border-[#a0a0a0] rounded-lg px-4 py-2.5 text-sm focus:border-primary outline-none transition-all"
                      placeholder="••••••••••••••••"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-background border border-[#a0a0a0] rounded-lg px-4 py-2.5 text-sm focus:border-primary outline-none transition-all h-[115px] resize-none"
            ...
            {/* Migration Section */}
            <div className="bg-surface-lowest rounded-xl border border-[#a0a0a0] shadow-ambient overflow-hidden">
              <div className="bg-surface-low px-6 py-3 border-b border-[#a0a0a0] flex items-center space-x-2">
