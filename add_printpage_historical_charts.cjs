...
// The replacement code for the advanced charts
const advancedChartsCode = `
...
content = content.replace(/if \(rvChartType === 'evolucion'\) \{/, advancedChartsCode);

fs.writeFileSync('src/pages/PrintPage.jsx', content, 'utf8');
console.log('Added historical_advanced charts rendering logic');
